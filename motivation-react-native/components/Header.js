  ...
  renderOptions = () => {
    ...
    return (
      <Block row style={styles.options}>
        {/* ///////////////////beauty///////////////////////////// */}
        <Button shadowless style={[styles.tab, styles.divider]} onPress={() => navigation.navigate('MessageList')}>
          <Block row middle>
            <Icoon size={20} name="inbox" family="FontAwesome5" style={{ paddingRight: 8 }} color={argonTheme.COLORS.ICON} />
            <Text size={16} style={styles.tabTitle}>{optionLeft || 'Message'}</Text>
          </Block>
        </Button>
        <Button shadowless style={styles.tab} onPress={() => navigation.navigate('Home')}>
          <Block row middle>
            ...
            <Text size={16} style={styles.tabTitle}>{optionRight || 'Post'}</Text>
          </Block>
        </Button>
      </Block>
    );
